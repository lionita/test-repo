...
INSERT INTO auction.auctions (id, title, description, reserve_price, min_increment, start_time, end_time, status, current_price, winning_bid_id)
VALUES (
...
INSERT INTO auction.bidders (id, first_name, last_name, email, national_id, purchasing_authorization_limit, created_at, deleted_at, blocked_until)
VALUES
...
INSERT INTO auction.bids (id, auction_id, bidder_id, amount, sequence_number, idempotency_key, bid_status, reject_reason, created_at)
VALUES
...
INSERT INTO auction.outbox_events (id, event_type, aggregate_id, payload, created_at, published_at, publish_attempts, next_attempt_at, dead_lettered_at, last_error)
VALUES
